...
# 城市数据集
data_arg.add_argument('--city_data', type=str, default="data/st70.tsp", help='data path')
# 城市数量
data_arg.add_argument('--city_num', type=int, default=70, help='city num')
# 城市位置维度
data_arg.add_argument('--pos_dimension', type=int, default=2, help='pos_dimension')
# 种群个体数（50-100）
data_arg.add_argument('--individual_num', type=int, default=60, help='individual num')
# 迭代次数
data_arg.add_argument('--gen_num', type=int, default=500, help='generation num')
# 精英保留比例
data_arg.add_argument('--elite_ratio', type=float, default=0.03, help='probability of elite')
# 交叉概率
data_arg.add_argument('--cross_prob', type=float, default=0.98, help='probability of cross')
# 变异概率
data_arg.add_argument('--mutate_prob', type=float, default=0.3, help='probability of mutate')
